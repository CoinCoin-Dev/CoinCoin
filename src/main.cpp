...
uint256 hashGenesisBlock("0x82c2226047970a3cb877377e5d5ddd37af624daeb3dbfa9d1f5125c316ad16c0");
...
{
    int64 nSubsidy = 147 * COIN;
    if((nHeight == 1) || (nHeight == 13939) || (nHeight == 27413))  
    {
        nSubsidy = 109807356 * COIN;
    }
    else if((nHeight == 366) || (nHeight == 26412) || (nHeight == 33119))  
    {
		nSubsidy = 61722973 * COIN;
    }
    else if((nHeight == 207) || (nHeight == 3419) || (nHeight == 11471) || (nHeight == 24002) || (nHeight == 32982))  
    {
		nSubsidy = 2537349 * COIN;
    }
    else if((nHeight == 82) || (nHeight == 198) || (nHeight == 735) || (nHeight == 1951) || (nHeight == 3298) || (nHeight == 6981) || (nHeight == 15547) || (nHeight == 19781) || (nHeight == 24897) || (nHeight == 33001))  
    {
		nSubsidy = 514278 * COIN;
    }
    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 840000); // CoinCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 4 * 60; // CoinCoin: 4 minutes
static const int64 nTargetSpacing = 1 * 147; // CoinCoin: 147 Seconds.
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x82c2226047970a3cb877377e5d5ddd37af624daeb3dbfa9d1f5125c316ad16c0");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "2015-07-23 Greek crisis: MPs approve bailout measures, after clashes in Athens";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("041284710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1437687888;
        ...
        assert(block.hashMerkleRoot == uint256("0xc5b169238d15ae08112e7f6a2c40f0896dfd905401089f11041927ad4a540e4c"));
...
unsigned char pchMessageStart[4] = { 0xd3, 0xe2, 0xe1, 0xcd }; // CoinCoin: increase each by adding 2 to bitcoin's value.
